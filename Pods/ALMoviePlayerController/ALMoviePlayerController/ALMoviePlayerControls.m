...
@property (nonatomic, strong) ALButton *volumeView;
...
//        [_topBar addSubview:_scaleButton];
        ...
        _volumeView = [[ALButton alloc] init];
        _volumeView.delegate = self;
        [_volumeView setImage:[UIImage imageNamed:@"fluent.png"] forState:UIControlStateNormal];
        [_volumeView setImage:[UIImage imageNamed:@"fluent.png"] forState:UIControlStateSelected];
...
//        [_bottomBar addSubview:_volumeView];
        ...
        [_soundButton setImage:[UIImage imageNamed:@"sound.png"] forState:UIControlStateSelected];
        _soundButton.delegate = self;
        [_soundButton addTarget:self action:@selector(seekForwardPressed:) forControlEvents:UIControlEventTouchUpInside];
        [_bottomBar addSubview:_soundButton];

        
        
        
        _seekForwardButton = [[ALButton alloc] init];
        [_seekForwardButton setImage:[UIImage imageNamed:@"record.png"] forState:UIControlStateNormal];
        [_seekForwardButton setImage:[UIImage imageNamed:@"record.png"] forState:UIControlStateSelected];
        ...
        [_seekBackwardButton setImage:[UIImage imageNamed:@"capture.png"] forState:UIControlStateNormal];
        [_seekBackwardButton setImage:[UIImage imageNamed:@"capture.png"] forState:UIControlStateSelected];
    ...
    [_playPauseButton setImage:[UIImage imageNamed:@"play.png"] forState:UIControlStateSelected];
...
- (void)layoutSubviews {
    ...
    if (self.style == ALMoviePlayerControlsStyleFullscreen || (self.style == ALMoviePlayerControlsStyleDefault && self.moviePlayer.isFullscreen)) {
        ...
        //bottom bar
//        NSLog(@"========%f====%f",_bottomBar.frame.size.width,_bottomBar.frame.origin.x);
        self.bottomBar.frame = CGRectMake(0, self.frame.size.height - self.barHeight, self.frame.size.width, self.barHeight);
        self.playPauseButton.frame = CGRectMake(209.5f, 9, 185, 40);
        self.seekForwardButton.frame = CGRectMake(435, 13, 30, 30);
        self.seekBackwardButton.frame = CGRectMake(125.6f, 13, 30, 30);
        self.soundButton.frame = CGRectMake(568-55.6, 13, 30, 30);
        ...
        if (self.frame.size.width <= iPhoneScreenPortraitWidth) {
            ...
            self.volumeView.frame = CGRectMake(29, 19, 40, 23);
        }
